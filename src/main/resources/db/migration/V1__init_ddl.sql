...
create index item_idx01 on items (item_token);
...
(
    ...
    ordering               tinyint not null comment '정렬순서',
    item_option_group_name varchar(30) not null comment '옵션그룹명 (색상, 사이즈 등)',
    created_at             datetime(6) not null comment '생성 일시',
    updated_at             datetime(6) null comment '수정 일시'
) comment 'item_option_groups' charset = utf8mb4;

create index item_option_group_idx01 on item_option_groups (item_id);
create index item_option_group_idx02 on item_option_groups (created_at);
create index item_option_group_idx03 on item_option_groups (updated_at);
...
(
    ...
    item_option_price    int not null comment '상품 옵션 가격',
    created_at           datetime(6) not null comment '생성 일시',
    updated_at           datetime(6) null comment '수정 일시'
) comment 'item_options' charset = utf8mb4;

create index item_option_idx01 on item_options (item_option_group_id);
create index item_option_idx02 on item_options (created_at);
create index item_option_idx03 on item_options (updated_at);
...
create index order_idx01 on orders (order_token);
create index order_idx02 on orders (user_id);
create index order_idx03 on orders (ordered_at);
create index order_idx04 on orders (created_at);
create index order_idx05 on orders (updated_at);
...
create index order_item_idx01 on order_items (order_id);
create index order_item_idx02 on order_items (partner_id);
create index order_item_idx03 on order_items (item_id);
create index order_item_idx04 on order_items (item_token);
create index order_item_idx05 on order_items (created_at);
create index order_item_idx06 on order_items (updated_at);
...
create index order_item_option_groups_idx01 on order_item_option_groups (order_item_id);
create index order_item_option_groups_idx02 on order_item_option_groups (created_at);
create index order_item_option_groups_idx03 on order_item_option_groups (updated_at);
...
create index order_item_options_idx01 on order_item_options (order_item_option_group_id);
create index order_item_options_idx02 on order_item_options (created_at);
create index order_item_options_idx03 on order_item_options (updated_at);
